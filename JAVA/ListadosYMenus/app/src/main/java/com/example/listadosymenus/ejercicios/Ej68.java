...
public class Ej68 extends AppCompatActivity {
    TextView tvTitle;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        sp = findViewById(R.id.spinnerVersiones);
        ...
        sp.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onNothingSelected(AdapterView<?> parent) {
                ...
                tvTitle.setText("ANGEL MIGUEL FELIPE");
                tvDescription.setText("Desarrollado por Angel ;)");
