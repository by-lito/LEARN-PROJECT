...
import com.acc.datos.hybernate_project.servicios.SetupInicialService;
...
public class AppRunner implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        try {
            // Intentamos ejecutar el método transaccional.
            setupInicialService.crearDatosDeEjemplo();

        } catch (DataIntegrityViolationException e) {
            // Si algo falla dentro del método (ej. un DNI duplicado),
